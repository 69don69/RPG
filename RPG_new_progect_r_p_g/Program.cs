...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool game = false;
            Demonessa Demonessa1 = new Demonessa("Демонесса", 100, 50, 200, 0, true);
            Chupocabra Chupocabra1 = new Chupocabra("Чупокабра", 100, 50, 200, 0, true);
            Slut Slut1 = new Slut("Ночная бабочка", 100, 50, 200, 0, true);
            Maffioze Maffioze1 = new Maffioze("Мафиозе", 100, 50, 200, 0, true);
            Demonessa Mag = new Demonessa("Маг", 100, 50, 200, 0, true);
            Chupocabra Gem = new Chupocabra("Самоцвет", 100, 50, 200, 0, true);
            Slut Fet = new Slut("Фея", 100, 50, 200, 0, true);
            Maffioze Robot = new Maffioze("Робот", 100, 50, 200, 0, true);
            ...
            while (game == true)
            {
                if (turn == true)
                {
                    ...
                    {
                        Demonessa1.attack(Mag);
                    }
                    if (podacha == "1" && priyom == "2")
                    {
                        Demonessa1.attack(Gem);
                    }

                    if (podacha == "1" && priyom == "3")
                    {
                        Demonessa1.attack(Fet);
                    }

                    if (podacha == "1" && priyom == "4")
                    {
                        Demonessa1.attack(Robot);
                    }

                    if (podacha == "2" && priyom == "1")
                    {
                        Chupocabra1.attack(Mag);
                    }

                    if (podacha == "2" && priyom == "2")
                    {
                        Chupocabra1.attack(Gem);
                    }

                    if (podacha == "2" && priyom == "3")
                    {
                        Chupocabra1.attack(Fet);
                    }

                    if (podacha == "2" && priyom == "4")
                    {
                        Chupocabra1.attack(Robot);
                    }
                    ...
                    {
                        Maffioze1.attack(Mag);
                    }

                    if (podacha == "4" && priyom == "2")
                    {
                        Maffioze1.attack(Gem);
                    }

                    if (podacha == "4" && priyom == "3")
                    {
                        Maffioze1.attack(Fet);
                    }

                    if (podacha == "4" && priyom == "4")
                    {
                        Maffioze1.attack(Robot);
                    }
                ...
                if (turn == false)
                {
                    ...
                    if (podacha == "1" && priyom == "1")
                    {
                        Mag.attack(Demonessa1);
                    }
                    if (podacha == "1" && priyom == "2")
                    {
                        Mag.attack(Chupocabra1);
                    }
                    if (podacha == "1" && priyom == "3")
                    {
                        Mag.attack(Slut1);
                    ...
                    if (podacha == "1" && priyom == "4")
                    {
                        Mag.attack(Maffioze1);
                    }
                    if (podacha == "2" && priyom == "1")
                    {
                        Gem.attack(Demonessa1);
                    }
                    if (podacha == "2" && priyom == "2")
                    {
                        Gem.attack(Chupocabra1);
                    }
                    if (podacha == "2" && priyom == "3")
                    {
                        Gem.attack(Slut1);
                    ...
                    if (podacha == "2" && priyom == "4")
                    {
                        Gem.attack(Maffioze1);
                    }
                    if (podacha == "3" && priyom == "1")
                    {
                        Fet.attack(Demonessa1);
                    }
                    if (podacha == "3" && priyom == "2")
                    {
                        Fet.attack(Chupocabra1);
                    }
                    if (podacha == "3" && priyom == "3")
                    {
                        Fet.attack(Slut1);
                    ...
                    if (podacha == "3" && priyom == "4")
                    {
                        Fet.attack(Maffioze1);
                    }
                    if (podacha == "4" && priyom == "1")
                    {
                        Robot.attack(Demonessa1);
                    }
                    if (podacha == "4" && priyom == "2")
                    {
                        Robot.attack(Chupocabra1);
                    }
                    if (podacha == "4" && priyom == "3")
                    {
                        Robot.attack(Slut1);
